var baseWebUrl = "/application";
var app = angular.module('landlordWebApp', ['ngRoute', 'landlordServices', 'uiGmapgoogle-maps', 'ui.bootstrap', 'digitalfondue.dftabmenu', 'angular.filter','ngSanitize', 'open-exchange-rates','decimal-places','ngMap','chart.js','nsPopover','angulartics','angulartics.google.analytics','vcRecaptcha','angularFileUpload','pascalprecht.translate' , 'angularUtils.directives.dirPagination']);
...
app.config(['$routeProvider','$locationProvider', function ($routeProvider,$locationProvider) {
  $routeProvider
    ...
    .when("/submit_property_request", {templateUrl: "views/submit_property_request.html", controller: "SubmitPropertyRequestCtrl"})
     .when("/list_ur_prperty", {templateUrl: "views/list_ur_property_form.html", controller: "ListYourPropertyCtrl"})
...
app.directive('propertydetailgrade', function() {
	return {
		restrict: "E",
	    templateUrl: "templates/property_details_grade.html",
...
app.directive('gradetable', function() {
	return {
		restrict: "E",
	    templateUrl: "templates/grade_table.html",
...
landlordServices.factory('ContactService',['$resource', function ($resource) {
    return $resource(baseWebUrl  +'/contacts', {}, {
...
landlordServices.factory('ShareMailService',['$resource', function ($resource) {
    return $resource(baseWebUrl +'/sharemail', {}, {
...
landlordServices.factory('PropertyQueryService',['$resource', function ($resource) {
    return $resource('http://localhost/Landlord/landlord/application/Search', {}, {
...
/*landlordServices.factory('QueryService',['$resource', function ($resource) {
    return $resource(baseWebUrl  +'/query', {}, {
...
app.controller('DetailsCtrl', ['$scope','$routeParams','$location','$rootScope','$window','$filter','SearchService','ShortlistService','CommonShareService','$modal', '$log','$timeout','getRateInfo','numberFilter','$q','$anchorScroll',function ($scope, $routeParams, $location, $rootScope, $window, $filter, SearchService, ShortlistService,CommonShareService,$modal, $log, $timeout,getRateInfo,numberFilter,$q,$anchorScroll ) {
...
//   	    			}}
   	 ...
   	 //function for clear scenario  
	      ...
	      $scope.lala = function () { 
	    	  $scope.navigationState = 'tab-description';
...
}]);app.controller('HomePageCtrl', ['$scope','$rootScope','$window','SearchService', function ($scope,$rootScope, $window, SearchService) {
...
app.controller('PropertiesCtrl', ['$scope','$rootScope','$filter','$timeout','$location','$window','SearchService','ShortlistService','CommonShareService','$modal', '$log','$routeParams','uiGmapGoogleMapApi','uiGmapIsReady','getRateInfo','numberFilter','$q','$translate', function ($scope,$rootScope,$filter,$timeout,$location, $window, SearchService,  ShortlistService,CommonShareService, $modal, $log,$routeParams,uiGmapGoogleMapApi,uiGmapIsReady,getRateInfo,numberFilter,$q,$translate) {
			 ...
			 $scope.gotoloantab = function () {
				 ...
				 $rootScope.scrolltoloan = true;
				  ...
				  $scope.numberOfPages=function(){
					  return Math.ceil($scope.bigTotalItems/$scope.pageSize);
					 }
				 ...
				 ////////////////////////////////////////////////////////////////
				  ...
				  $scope.searchproperties = [];
					SearchService.success(function(data) { 
						$scope.searchproperties = data.properties;
						
						//console.log($scope.searchproperties.length);
				...
				/*  var Schema = mongoose.Schema;
				  var propertySchema = new Schema({
					  ...
					  mofifiedon: { type: String, required: true },
