...
<div class="col-sm-12 nopadding">
					<p><b>Click to respond:</b>
						<a class="" href="javascript:void(0);" style="text-decoration: underline;color:grey;pointer-events: none;cursor: not-allowed;" title="YES buy ipr and grade report" target="_blank"><b>YES</b> buy ipr and grade report</a> |
						<a class="" href="javascript:void(0);" style="text-decoration: underline;color:grey;pointer-events: none;cursor: not-allowed;" title="NO reject request" target="_blank"><b>NO</b> reject request</a> 
					</p>
			</div>
-->
