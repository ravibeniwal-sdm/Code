...
<div class="container cpxcontent" >
	<div class="row datacontainer">
			...
			<div class="col-sm-12 nopadding">
				...
				<p><b>Dear  property owner/ agent,</b></p>
				...
				<p style="padding-left:10px;"><b>Subject:</b> <?php echo $data['subject']; ?></p>
				<p style="padding-left:10px;"><b>Message:</b> <?php echo $data['message']; ?> <?php echo $data['links']; ?></p>    
