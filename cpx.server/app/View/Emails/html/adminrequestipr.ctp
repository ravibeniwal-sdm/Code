...
<div class="container cpxcontent" >
	<div class="row datacontainer">
			...
			<p style="padding-left:10px;"><b>Name:</b> <?php echo $data['name']; ?><br/>
			<b>Email:</b> <?php echo $data['email']; ?></p>
			
			<p><b>Submitted to:</b></p>
			<?php foreach ($data['emailRecipients'] as $emailRecipient) { ?>
				<p style="padding-left:10px;"><b>Name: </b><?php echo ($emailRecipient['name']); ?><br/>
				<b>Email: </b><?php echo ($emailRecipient['label']); ?></p>
			<?php } ?>
