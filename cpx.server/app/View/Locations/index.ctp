...
{
    active_locations = $('#active_locations').val();
    $.ajax({
        url: '<?=ADMIN_PATH?>locations/toggleStatus/'+id,
        cache: false,
        type: 'POST',
        dataType: 'json',
        error: function (data) {
        ...
        success: function (data) {
            ...
            $('#active_locations').val(data.active_locations);
            
            value_span_active_locations = data.active_locations;
            $('#span_active_locations').html(value_span_active_locations);                        
        }
    });
    ele.preventDefault();
    return false;
...
function updateDisplayOrder() {
    ...
    var dataString = 'sort_order='+selectedLanguage;
        $.ajax({
            type: "POST",
            url: '<?=ADMIN_PATH?>locations/changeorder/<?=$currentPage?>',
            data: dataString,
            cache: false,
	...
	<div id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Settings <span>&gt; Locations</span></h1>
			</div>
            ...
            <section class="col col-9" style="float: right;" >
                ...
                <section class="col col-4" >          
                    <ul id="sparks" class="">                
    					<li class="sparks-info">
    						<h5> Active locations <span id="span_active_locations" style="text-align: center;" ><?php echo $active_locations; ?></span></h5>
    					</li>
                    </ul>
				</section>
                ...
                <section class="col col-4" >        
                    <ul id="sparks" class="">                         
    					<li class="sparks-info">
    						<h5> Total locations <span  style="text-align: center;" ><?php echo $total_locations ?></span></h5>
    					</li>
    				</ul>
                </section>
						...
						<div>
							...
							<div class="widget-body">
                                <div class="col col-12" style="float: right;">
                                    ...
                                    <a class="btn btn-primary col col-3" href="javascript:void(0);" onclick="window.location.href='<?=ADMIN_PATH?>locations/add'" style="margin-bottom: 10px;">Add new location</a>                                                      
                                       
                                </div>
								
								<div class="custom-scroll table-responsive" >
								
									<table class="table table-bordered" id="locations_list">
										<?php echo $this->element('admin/location_list'); ?>
									</table>
                                    <!--
<div class="text-right">
                                    ...
                                    ?>
                                    <li>
    									<a href="<?=ADMIN_PATH?>locations/index/<?=($currentPage-1)?>"><i class="fa fa-angle-left"></i></a>
    								</li>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <li class="<?=(($i==$currentPage)?"active":"")?>">
    									<a  href="<?=ADMIN_PATH?>locations/index/<?=($i)?>"><?=$i?></a>
    								</li>
    								<?php
                                    }
                                    ?>
    								...
    								<li>
    									<a href="<?=ADMIN_PATH?>locations/index/<?=($currentPage+1)?>"><i class="fa fa-angle-right"></i></a>
    								</li>
                                    <?php
                                    }
                                    ?>
