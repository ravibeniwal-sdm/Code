...
<div id="main" role="main">
      ...
      <?php
		...
		<section id="widget-grid" class="">
            <form id="add_form" class="customeUploadForm" method="post" action="<?=ADMIN_PATH?>sponsors/add">
			<!-- row -->
			<div class="row">
                            ...
                            <fieldset>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form "  >
                                    ...
                                    <section class="col col-9">
                                        ...
                                        <span>
                                            <input class="form-control" type="text" name="sponsor_name" id="sponsor_name" placeholder="Enter Sponsor name" />
                                        </span>
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form "  >
                                   <section class="col-6 col-sm-6 col-md-6" > 
                                    ...
                                    <section class="col col-6">
                                        ...
                                        <span>
                                            <select class="form-control " name="loan_type" id="loan_type" placeholder="Select loan type">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form "  >
                                    <section class="col-6 col-sm-6 col-md-6" >
                                        ...
                                        <section class="col col-6" >
                                            ...
                                            <span>
                                                <input class="form-control" type="text" name="term" id="term" placeholder="Enter Loan term" />
                                            </span>
                                    ...
                                    <span id="intrest_rate_error" style="color: red; font-size: 11px;display: none;">Please enter Interest rate</span>
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <span>
                                                <input class="form-control " type="text" name="intrest_rate" id="intrest_rate" placeholder="Enter Interest rate" />
        									</span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form" >
                                    ...
                                    <section class="col col-9">
                                        ...
                                        <span>
                                            <input  class="form-control" onfocus="$('#url_error').hide();" onkeydown="$('#url_error').hide();" onblur="show_preview();" type="text" name="url" id="url" placeholder="Enter Advertising link"/>
                                        </span>
