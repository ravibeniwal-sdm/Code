...
<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Add new endorsements</li>
				</ol>
				<!-- end breadcrumb -->
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark"><i class="fa fa-table fa-fw "></i> Add new endorsements</h1>
			</div>
      ...
      <?php
		...
		<section id="widget-grid" class="">
            <form id="add_form" class="customeUploadForm" method="post" action="<?=ADMIN_PATH?>endorsements/add">
			<!-- row -->
			<div class="row">
                            ...
                            <fieldset>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form" >
                                    ...
                                    <section class="col col-9">
                                        ...
                                        <div class="custom_upload_file_widget disable logo_div">
                            ...
                            if(isset($endorsements['logo'])){
                                           ...
                                           <input type="hidden" id="AgreementDoc_name" name="AgreementDoc_name[]" value=" <?php echo $detail_logo['name'];?>"/>
                                            ...
                                            <input type="hidden" name="AgreementDoc_isurl[]" value="<?php echo (isset($detail_logo['isurl'])? $detail_logo['isurl']:'0');?>"/>
                                                           ...
                                                           <?php
                            								...
                            								<td><a href="#" onclick="removeFile();" class="table-icon nomargin" title="Delete"> <i class="glyphicon glyphicon-trash delete"></i>
                            								</a></td>
                            							</tr>
                            							<?php
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form "  >
                                    ...
                                    <section class="col col-9 disable logo_div">
                                        ...
                                        <span>
                                            <input class="form-control" type="text" name="logo_width" id="logo_width" placeholder="Enter width of logo" onchange="change_logo_size('width')"/>
                                        </span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form "  >
                                    ...
                                    <section class="col col-9 disable logo_div" >
                                        ...
                                        <span>
                                            <input class="form-control" type="text" name="logo_height" id="logo_height" placeholder="Enter height of logo" onchange="change_logo_size('height')"/>
                                        </span>
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form" >
                                    ...
                                    <section class="col col-9">
                                        ...
                                        <span  class="disable text_div">
                                            <textarea class="form-control" onfocus="$('#text_error').hide();" onkeydown="$('#text_error').hide();" name="text" id="company_text" ></textarea>
    									</span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 smart-form" >
                                    ...
                                    <section class="col col-9">
                                        ...
                                        <span>
                                            <input class="form-control" onfocus="$('#url_error').hide();" onkeydown="$('#url_error').hide();" onblur="show_preview();" type="text" name="url" id="url" placeholder="Enter URL of website"/>
                                        </span>
...
$(document).ready(function () {
    var logo_actual_width = 0;
    var logo_actual_height = 0;
