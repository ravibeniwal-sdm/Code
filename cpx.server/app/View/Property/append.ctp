        ...
        rules:
        {
          "contract_of_sale":{ required:true,
                            depends: function(element) {
                                   return $('#AgreementDoc_name').val().length > 0 || $('#AgreementDoc_path').val().length > 0
                                        }
...
<!-- RIBBON -->
        ...
        ?>
                <div class="row">
                 ...
                 <script language="javascript" type="text/javascript">
                 setTimeout("redirectpage('<?=$propertyInfo['id']?>')",1000);
                 </script>
      <?php
            }
        ?>
        ...
        <form class="" action="<?=ADMIN_PATH?>property/append/<?=$propertyInfo['id']?>/true" id="propertyAppend" method="post" enctype="multipart/form-data">
		...
		<section id="widget-grid" class="">
            ...
            <input style="float: right;" class="btn btn-primary " type="submit" value="Save & Return" />
            <input style="float: right;margin-right: 5px;" class="btn  btn-default" type="button" onclick="redirectpage('<?=$propertyInfo['id']?>');" value="Cancel" />
